        ...
        <script>
            var FluData = {
                ...
                loadLayerNames: function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: this.url + "/geoserver/rest/workspaces/fluf/coveragestores.json",
                        dataType: "json",
                        context: this,
                        success: function(data) {
                            ...
                            if (data.coverageStores !== null && data.coverageStores.coverageStore[0] !== null) {
                                ...
                                $.each(stores, function(key, store) {
                                    var strDate = store.name.replace("flufreqstore", "");
                                    var layerName = "fluf:" + strDate;
            ...
            <div id="main-area">                
                <div id="content-area">
                    ...
                    <div id="content-area-left">
                        ...
                        <div class="news-head">
                            <div>
                                INFLUENZA SPREAD IN OHIO - <span id="divDate">2015 June 10</span>
                            </div>
                        </div>                    
                        ...
                        <div class="event-area">
                            ...
                            <div>
                                <div id="accordion">
                                    ...
                                    <h3>Legend</h3>
                                    <div>
                                        <img src="http://localhost:8080/geoserver/wms?FORMAT=image%2Fjpeg&TRANSPARENT=true&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetLegendGraphic&EXCEPTIONS=application%2Fvnd.ogc.se_xml&LAYER=fluf%3A2015Jun01&scale=3466753&legend_options=fontSize:10;bgColor:0xFFFFEE;dpi:130;fontStyle:normal"/>
                                        <p>
                                            To be implemented.
                                        </p>
                                    </div>
